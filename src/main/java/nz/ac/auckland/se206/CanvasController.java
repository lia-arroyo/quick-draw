...
public class CanvasController {
	...
	/**
	 * This method is responsible for running the timer. The timer is used to notify
	 * the user how much time they have left, and it is also used to refresh the
	 * model predictions every second.
	 */
	...
	/**
	 * This method updates the counter shown to the user by receiving the current
	 * time left as input. When the time reaches 0, the text shows "Time up".
	 *
	 ...
	 *
	 * @throws TranslateException if there is an error while getting the predictions
	 *                            from the model
	 */
	private void updatePrediction(Timer timer, BufferedImage snapshot) throws TranslateException {
		...
		Task<Void> predictionTask = new Task<Void>() {
			@Override
	...
	/**
	 * This method is called when the round ends, either by winning or losing
	 * (running out of time).
	 *
	...
	/**
	 * This method is called when the user clicks on the switch button. If they are
	 * currently using the brush, clicking the button will change the brush to the
